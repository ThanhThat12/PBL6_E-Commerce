package com.PBL6.Ecommerce.controller.payment;
...
import com.PBL6.Ecommerce.domain.dto.payment.MoMoRefundRequestDTO;
...
public class MoMoPaymentController {
    ...
    public ResponseEntity<ResponseDTO<MoMoRefundResponseDTO>> refundPayment(
            @RequestBody MoMoRefundRequestDTO request,
            Authentication authentication) {
        try {
            Jwt jwt = (Jwt) authentication.getPrincipal();
            Long userId = userService.extractUserIdFromJwt(jwt);
            ...
            // Process refund
            MoMoRefundResponseDTO refundResponse = moMoService.refundPayment(
                request.getOrderId(),
                request.getAmount(),
