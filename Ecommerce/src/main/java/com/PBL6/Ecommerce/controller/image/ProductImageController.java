package com.PBL6.Ecommerce.controller.image;
...
public class ProductImageController {
    ...
    @PreAuthorize("hasAnyRole('SELLER', 'ADMIN')")
    public ResponseEntity<ResponseDTO<com.PBL6.Ecommerce.domain.dto.response.VariantImageResponse>> uploadVariantImage(
            @PathVariable Long productId,
            @RequestParam("file") MultipartFile file,
        ...
        Long userId = extractUserId(authentication);
        com.PBL6.Ecommerce.domain.dto.response.VariantImageResponse response = 
     ...
     */
    @GetMapping("")
    public ResponseEntity<ResponseDTO<com.PBL6.Ecommerce.domain.dto.response.ProductImagesResponse>> getAllProductImages(
            @PathVariable Long productId) {
        
        log.info("GET /api/products/{}/images - Retrieve all product images", productId);
        
        com.PBL6.Ecommerce.domain.dto.response.ProductImagesResponse response = 
    ...
    @PreAuthorize("hasAnyRole('SELLER', 'ADMIN', 'BUYER')")
    public ResponseEntity<ResponseDTO<com.PBL6.Ecommerce.domain.dto.response.PrimaryAttributeDTO>> getPrimaryAttribute(
            @PathVariable Long productId) {
        
        log.info("GET /api/products/{}/images/primary-attribute - Get primary attribute info", productId);
        
        com.PBL6.Ecommerce.domain.dto.response.ProductImagesResponse imageResponse = imageService.getProductImages(productId);
        com.PBL6.Ecommerce.domain.dto.response.PrimaryAttributeDTO primaryAttribute = imageResponse.getPrimaryAttribute();
