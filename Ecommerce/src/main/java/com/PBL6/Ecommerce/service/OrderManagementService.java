...
/**
 * Legacy OrderService - to be migrated to OrderManagementService
 * This service handles admin and seller order operations
 */
...
public class OrderManagementService {
    ...
    public OrderManagementService(ProductRepository productRepository,
...
@Transactional
    ...
    private OrderDTO convertToDTO(Order order) {
        ...
        dto.setMethod(order.getPaymentMethod() != null ? order.getPaymentMethod().name() : null);
